    ...
    <AppProvider>
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-8 relative z-10">
        ...
        <section id="components" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start py-8">
          ...
          <div ref={parentRef} className="lg:col-span-9 overflow-auto" style={{ contain: 'strict', height: '100%' }}>
            ...
            {filteredComponents.length === 0 ? (
              ...
              <div style={{ height: `${rowVirtualizer.getTotalSize()}px`, width: '100%', position: 'relative' }}>
                {rowVirtualizer.getVirtualItems().map((virtualItem) => {
                  const comp = filteredComponents[virtualItem.index];
                  ...
                  return (
                    ...
                    >
                      <div className="glass rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden group flex flex-col gap-6 mb-10">
