...
export const GlassmorphicGlassCard = React.forwardRef<HTMLDivElement, GlassmorphicGlassCardProps>(({ color = 'violet' }, ref) => {
  ...
  return (
    <div ref={ref} className="relative group p-6 rounded-2xl bg-white/5 dark:bg-slate-900/40 backdrop-blur-xl border border-white/10 dark:border-white/5 hover:border-white/20 transition-all duration-300 hover:translate-y-[-4px] shadow-2xl max-w-sm">
