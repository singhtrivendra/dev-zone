...
export const GradientBorderButton = React.forwardRef<HTMLButtonElement, GradientBorderButtonProps>(({ color = 'violet' }, ref) => {
  ...
  return (
    <button ref={ref} className="relative p-[1.5px] rounded-xl overflow-hidden group bg-transparent transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]">
